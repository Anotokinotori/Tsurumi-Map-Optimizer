...
const actionDetails = {
    ...
    19: { images: ['https://assets.st-note.com/img/1741392581-OlQNcjt2W14iaRJymhSG0VdI.png?width=1200', 'https://assets.st-note.com/img/1741392586-2SUxeY4fBXj7z918Tok0nqHu.png?width=1200'], videoUrl: 'https://youtu.be/XbqcgyuE0vw?si=Xf3wZ57Y_nxWjBW8', note: 'シリコロのボートポイントからの移動です。ボートポイントにはポケワを置くのがおすすめですが、セイライ島やヤシオリ島から海を渡って来ても大丈夫です。\n目印はミントです。\n極力動画と同じように移動してください。' },
